...
const HtmlIcon = () => (
  <svg viewBox="0 0 24 24" className="w-10 h-10" fill="none">
    <path d="M3 0h18l-1.7 19.6L12 24 4.7 19.6 3 0Z" fill="#E34F26" />
    <path d="M12 22.6 17.4 20.8 18.8 4.4H12v18.2Z" fill="#EF652A" />
    <path d="M8.6 7.7H15.4l-.3 3.6H8.6l.3 3.7h6.3l-.3 3.4-3.4.9-3.4-.9-.2-2.4h2.3l.1 1.1 1.2.4 1.2-.4.1-1.3H8.6l-.3-3.8h6.6l.2-2.6H8.6l.1-1.3Z" fill="#fff" />
  </svg>
);

const CssIcon = () => (
  <svg viewBox="0 0 24 24" className="w-10 h-10" fill="none">
    <path d="M3 0h18l-1.7 19.6L12 24 4.7 19.6 3 0Z" fill="#1572B6" />
    <path d="M12 22.6 17.4 20.8 18.8 4.4H12v18.2Z" fill="#33A9DC" />
    <path d="M8.6 7.7H15.4l-.3 3.6H8.6l.3 3.7h6.3l-.3 3.4-3.4.9-3.4-.9-.2-2.4h2.3l.1 1.1 1.2.4 1.2-.4.1-1.3H8.6l-.3-3.8h6.6l.2-2.6H8.6l.1-1.3Z" fill="#fff" />
  </svg>
);
