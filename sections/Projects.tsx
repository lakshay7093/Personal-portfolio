...
import { Smartphone, Cloud, Layout, FileSpreadsheet, ExternalLink } from "lucide-react";
...
const projects = [
  {
    ...
    githubUrl: "https://github.com/lakshay9732saini/ninja-deliveries-customer",
    featured: true,
  },
  {
    ...
    liveUrl: "https://github.com/lakshay7093/ninja-deliveries-functions",
    githubUrl: "https://github.com/lakshay7093/ninja-deliveries-functions",
    featured: true,
  },
  {
    title: "Insta_Post",
    ...
    githubUrl: "https://github.com/lakshay7093/Insta_Post",
    featured: false,
  },
  {
    ...
    githubUrl: "https://github.com/lakshay7093/csv-excel-to-pdf-converter",
    featured: false,
  },
];
            ...
            >
              ...
              <div className="relative z-10 flex flex-wrap gap-4 mt-10">
                <a
                  ...
                  className={`flex items-center gap-2 bg-gradient-to-r ${project.gradient} hover:opacity-90 transition-all duration-300 px-6 py-3 rounded-xl font-semibold text-sm shadow-lg hover:scale-105`}
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 border border-white/10 hover:border-white/30 bg-white/5 transition-all duration-300 px-6 py-3 rounded-xl font-semibold text-sm"
                >
                  <GithubSVG className="text-current" />
                  GitHub
                </a>
              </div>
